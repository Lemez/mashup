...
NODE_DESCRIPTIONS = {
	...
	"Feature_Has_Phoneme_Ih_Spelled_Y_Not_End" => ["Words where a middle EE sound \n is spelt Y", "everything"],
	...
	"Feature_Has_Phoneme_K_Spelled_Ch" => ["Words where thenK sound \n is spelt CH", "school"],
	...
	"string_ear" => ["Words where the AIR sound \n is spelt EAR", "wearing"],
	"string_ore" => ["Words where the sound is OR", "before"],
	"string_ough" => ["Words that contain the letters OUGH", "enough"]
